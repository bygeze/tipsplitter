    ...
    <div className="container pb-2">
        ...
        <div className="ct-content row pt-3">
          <div className="input-group mb-2">
            ...
            <input type="text" disabled className="form-control" aria-label="Username" value={totalHours} aria-describedby="basic-addon1" />
            <span className="input-group-text" id="basic-addon2">€</span>
            <input type="text" value={totalMoney} onChange={(e) => setTotalMoney(e.target.value)} className="form-control" aria-label="Username" aria-describedby="basic-addon1" />
